...
from qe_metrics.utils.general import get_config_files_path_from_os_env, run_in_verbose
...
def run_in_while(products_file: str, config_file: str, verbose_db: bool) -> None:
    while True:
...
if __name__ == "__main__":
    ...
    proc = Process(
        target=run_in_while,
        kwargs={"products_file": products_file, "config_file": config_file, "verbose_db": run_in_verbose()},
    )
    proc.start()
