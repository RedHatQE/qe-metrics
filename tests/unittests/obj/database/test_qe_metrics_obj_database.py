...
class TestDatabase(unittest.TestCase):
    ...
    def test_database_initialization_with_valid_config(
        self,
        mock_connection,
        mock_get_logger,
    ):
    ...
    @patch("cli.obj.database.get_logger")
    @patch("cli.obj.database.connection")
    def test_database_initialization_without_filepath(
        self,
        mock_connection,
        mock_get_logger,
    ):
    ...
    @patch("cli.obj.database.get_logger")
    @patch("cli.obj.database.connection")
    def test_database_initialization_with_invalid_database_auth(
        self,
        mock_connection,
        mock_get_logger,
    ):
